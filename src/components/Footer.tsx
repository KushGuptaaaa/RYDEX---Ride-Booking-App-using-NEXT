...
import { SiFacebook, SiInstagram, SiX, SiLinkerd } from '@icons-pack/react-simple-icons'
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12'>
          <div>
            ...
            <div className='flex gap-4 mt-6'>
              {[SiFacebook, SiInstagram, SiX, SiLinkerd].map((Icon, i) => (
                <motion.a
                  key={i}
                  whileHover={{ y: -3 }}
                  href="#" // yaha pe link de sakte hai
